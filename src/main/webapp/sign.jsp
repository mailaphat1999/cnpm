...
<form class="form-login-regeter" action="<%=Utils.fullPath("dangnhap")%>" method="post">
    ...
    <div class=" login-geter">
        ...
        --%>
        <button class="login-buton" type="button" style="background: #2851A3 !important" onclick="window.location.href='https://www.facebook.com/dialog/oauth?client_id=282473129876153&redirect_uri=http://localhost:8080/cnpm/dangnhapbangFB';"><i class="fab fa-facebook-square" style="font-size: 20px"></i><span style="color: #fefefe"> Đăng nhập bằng Facebook</span></button>
		 <%-- 
            B3.3: Người dùng chọn nút Đăng nhập bằng Google
        --%>
		<button class="login-buton" type="submit" style="background: #EA4335 !important" onclick="window.location.href='https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=http://localhost:8080/cnpm/dangnhapbangGG&response_type=code&client_id=606065012158-dsiab1edvr6lsu3bohqhihmulphk3nke.apps.googleusercontent.com&approval_prompt=force';"><i class="fab fa-google" style="font-size: 20px"></i><span style="color: #fefefe"> Đăng nhập bằng Google</span></button>
